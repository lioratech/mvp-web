...
comment on column public.departments.external_id is 'External identifier for the department';
...
create index ix_departments_external_id on public.departments(external_id);
