...
CREATE TABLE IF NOT EXISTS public.account_payroll_events (
  ...
  external_id VARCHAR(255),
    main_event_id INTEGER REFERENCES public.main_events(id) ON DELETE SET NULL,
  description TEXT,
...
CREATE INDEX IF NOT EXISTS account_payroll_events_main_event_id_idx ON public.account_payroll_events(main_event_id); 