...
import { ExecutivePanels } from '../../../demo/executive/_components/executive-panels';

export function ExecutivePanelContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Temporariamente usando os gráficos demo */}
      <ExecutivePanels />
      ...
      {/* 
        ...
        const { data, isLoading, error } = usePanelData({
          panelName: 'executive-panel',
          tableName: 'panel_executive_data',
        });
        
        Renderizar componentes reais baseados em 'data'
      */}
    </div>
  );
}
